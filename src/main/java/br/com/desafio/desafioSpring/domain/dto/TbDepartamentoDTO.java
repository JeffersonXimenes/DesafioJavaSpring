...
public class TbDepartamentoDTO {
	...
	public TbDepartamentoDTO(TbDepartamentoEntity departamento) {
		this.departamentoId = departamento.getDepartamentoId();
		this.departamentoName = departamento.getDepartamentoName();
	}
}
